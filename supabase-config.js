// ─────────────────────────────────────────────────────────────
// Supabase 연결 설정
// 아래 두 값을 본인 프로젝트 값으로 교체하세요. (SETUP.md 참고)
//  - SUPABASE_URL      : 프로젝트 URL  (예: https://abcdwxyz.supabase.co)
//  - SUPABASE_ANON_KEY : anon public 키 (공개되어도 안전한 키)
// 데이터는 RLS 보안규칙으로 "본인 계정 행"만 접근 가능하게 보호됩니다.
//
